...
Backend image: underdogdevops/devopstech:backend-latest
Frontend image: underdogdevops/devopstech:frontend-latest
...
aws route53 create-hosted-zone \
  --name underdogdevops.tech \
  --caller-reference $(date +%s) \
  --hosted-zone-config Comment="Public hosted zone for underdogdevops.tech"
...
ZONE_ID=$(aws route53 list-hosted-zones-by-name --dns-name underdogdevops.tech --query "HostedZones[0].Id" --output text | sed 's/\/hostedzone\///')
